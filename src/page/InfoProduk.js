    ...
    const addProduct = async (e) => {
        ...
        try {
            ...
            if (file != null) {
                ...
                response = await axios.post("https://serversinaga.herokuapp.com/v1/Produk/add", {
                    id_penjual: user.id,
                ...
                await axios.post("https://serversinaga.herokuapp.com/v1/Produk/email")
                berhasil()
                await sleep(2 * 1000)
                navigasi("/home")
                // navigasi("/home");npm ru
            } else {
                await axios.post("https://serversinaga.herokuapp.com/v1/Produk/add", {
