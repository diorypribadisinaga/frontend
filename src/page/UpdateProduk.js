...
export default function UpdateProduk() {
    ...
    const fetchdata = async () => {
        try {
            ...
            SetUser(data)
            response = await axios.get("https://serversinaga.herokuapp.com/v1/Produk/add/form")
    ...
    const updateProduct = async (e) => {
        ...
        try {
            ...
            if (file != null) {
                let response = await axios.post("https://serversinaga.herokuapp.com/v1/Produk/add/image/cloudinary",
                    form,
                    {
                        headers: {
                ...
                response = await axios.put(`https://serversinaga.herokuapp.com/v1/Produk/update/${id}`, {
                ...
                // response = await axios.post("https://serversinaga.herokuapp.com/v1/Produk/email")
                // navigasi("/home");
                berhasil()
                await sleep(3 * 1000)
                navigasi(`/preview/produk/${id}`)
            } else {
                await axios.put(`https://serversinaga.herokuapp.com/v1/Produk/update/${id}`, {
                    id_penjual: id_penjual,
                    id_kategori: id_kategori,
                    nama_produk: nama_produk,
                    harga: harga,
