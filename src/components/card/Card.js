...
export default function CardProduk({ user }) {
    ...
    const getKategori = async () => {
        let response = await axios.get("https://serversinaga.herokuapp.com/v1/Produk/add/form")
        setKategori(response.data)
    }

    const getProducts = async () => {
        let response = await axios.get("https://serversinaga.herokuapp.com/v1/Produk");
    ...
    const kategori = async (id) => {
        let response = await axios.get(`https://serversinaga.herokuapp.com/v1/Produk/kategori/${id}`);
